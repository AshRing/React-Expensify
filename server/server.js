...
app.get('*', (req, res) => { //if the url path the user requested isn't in the public folder, just give them index.html
    res.sendFile(path.join(publicPath, 'index.html'));
}); //sets up a function to run when someone makes a get request to our server
